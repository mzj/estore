	...
	$.fn.lightbox = function(options) {
		...
		*/
		...
		$.fn.lightbox.defaults = {
		    triggerEvent: "click",
			allSet: false,
			fileLoadingImage: '../bundles/estoreshop/js/vendor/lightbox/images/loading.gif',
			fileBottomNavCloseImage: '../bundles/estoreshop/js/vendor/lightbox/images/closelabel.gif',
			overlayOpacity: 0.6,
			borderSize: 10,
